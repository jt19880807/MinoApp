...
public class CustomYearMonthPicker {
    /**
     * 定义结果回调接口
     */
    ...
    public CustomYearMonthPicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initView() {
        ...
        day_text=(TextView)datePickerDialog.findViewById(R.id.day_tv);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("abc","select:"+sdf.format(selectedCalender.getTime()));
                datePickerDialog.dismiss();
            }
        });
    }
