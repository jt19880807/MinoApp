 ...
 */
public class HSDBFragment extends BaseFragment implements MeterContract.HeatMeterView {
    ...
    private void init() {
        ...
        presenter.getHeatStationMeters(heatStationId, Constant.HEATSTATION_METER_DB);
    }
    ...
    private void showHeatMeters(){
        ...
        recyclerview.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                bundle.putInt(Constant.METER_TYPE,Constant.HEATSTATION_METER_DB);
