...
public class BaseException extends Exception {
    ...
    // 服务器错误
    public static final int  ERROR_API_SYSTEM=100;

    //用户名不存在
    public static final int  ERROR_LOGIN_NONAME=101;
    //密码错误
    public static final int  ERROR_LOGIN_PWDERROR=102;
    // 登录错误，用户名密码错误
    ...
    //账户被冻结
    public static final int  ERROR_API_ACCOUNT_FREEZE=103;
