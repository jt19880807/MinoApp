...
public class ErrorMessageFactory {
    public static  String create(Context context, int code){
        ...
        switch (code){
            ...
            case  ApiException.ERROR_LOGIN_NONAME:
                errorMsg = context.getResources().getString(R.string.error_login_noname);
                break;

            case  ApiException.ERROR_LOGIN_PWDERROR:
                errorMsg = context.getResources().getString(R.string.error_login_pwderror);
                break;
