 ...
 */
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor>,LoginContract.LoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginModel model=new LoginModel(apiservice);
        loginPresenter=new LoginPresenter(model,this);
    }
